...
/**
 * The main app home (fixtures list) — shown once a wallet is connected.
 * Extracted verbatim from the original app/page.tsx; logic unchanged.
 */
        ...
        <section className="grid items-center gap-8 py-10 sm:py-16 lg:grid-cols-[1.1fr_1fr]">
          <div>
            ...
            <p className="mt-5 max-w-md text-lg leading-relaxed text-chalk-dim">
              ...
              as it happens. Scores tell you{" "}
              <em className="not-italic text-chalk">what</em>. PitchPulse shows you{" "}
              <em className="not-italic text-chalk">why</em>.
            </p>
          </div>
